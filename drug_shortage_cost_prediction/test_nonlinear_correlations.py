"""
Non-linear Correlation Testing Script
Tests log, square, and square root transformations of features against target variable
"""
...
def main():
    ...
    print("=" * 80)
    print("Non-linear Correlation Testing")
    print("=" * 80)
    
    # Load final features from feature_target_correlations.csv
    print("\n1. Loading final features...")
    final_features_df = pd.read_csv('/Users/janakipantham/Desktop/drug_shortage_platform/drug_shortage_cost_prediction/feature_target_correlations.csv')
    ...
    print("\n4. Testing non-linear correlations...")
    correlation_results = []
    ...
    print(f"\n   Top 10 features by best correlation:")
    for idx, row in results_df.head(10).iterrows():
        print(f"     {row['Feature']}: {row['Best_Transformation']} ({row['Best_Correlation']:.6f})")
    
    # Save results
    results_df.to_csv('/Users/janakipantham/Desktop/drug_shortage_platform/drug_shortage_cost_prediction/nonlinear_correlations.csv', index=False)
    print(f"\n   Saved: nonlinear_correlations.csv")
    ...
    print("=" * 80)
    print("\nOutput file:")
    print("  nonlinear_correlations.csv - Non-linear correlation measures for each feature")
